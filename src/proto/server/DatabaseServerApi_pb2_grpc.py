...
class DatabaseServerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateDatabase = channel.unary_unary(
                ...
                response_deserializer=DatabaseServerApi__pb2.CreateDatabaseResponse.FromString,
                )
        ...
        self.ResetDatabase = channel.unary_unary(
                ...
                request_serializer=Common__pb2.DatabaseIdPasswordRequest.SerializeToString,
                response_deserializer=DatabaseServerApi__pb2.CreateDatabaseResponse.FromString,
                )
        self.UpdateDatabaseAllowConnections = channel.unary_unary(
                '/com.server.DatabaseServerService/UpdateDatabaseAllowConnections',
                request_serializer=Common__pb2.DatabaseIdConnectionsAllowRequest.SerializeToString,
                response_deserializer=Common__pb2.ResponseResult.FromString,
                )
        ...
        self.GetDatabaseStats = channel.unary_unary(
                ...
                request_serializer=Common__pb2.DatabaseIdRequest.SerializeToString,
                response_deserializer=DatabaseServerApi__pb2.DatabaseStatsOnServerResponse.FromString,
                )
...
class DatabaseServerServiceServicer(object):
    ...
    def UpdateDatabaseAllowConnections(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DatabaseServerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateDatabase': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=DatabaseServerApi__pb2.CreateDatabaseResponse.SerializeToString,
            ),
            ...
            'ResetDatabase': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=Common__pb2.DatabaseIdPasswordRequest.FromString,
                    response_serializer=DatabaseServerApi__pb2.CreateDatabaseResponse.SerializeToString,
            ),
            'UpdateDatabaseAllowConnections': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateDatabaseAllowConnections,
                    request_deserializer=Common__pb2.DatabaseIdConnectionsAllowRequest.FromString,
                    response_serializer=Common__pb2.ResponseResult.SerializeToString,
            ),
            ...
            'GetDatabaseStats': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=Common__pb2.DatabaseIdRequest.FromString,
                    response_serializer=DatabaseServerApi__pb2.DatabaseStatsOnServerResponse.SerializeToString,
            ),
...
class DatabaseServerService(object):
    ...
    def CreateDatabase(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/com.server.DatabaseServerService/CreateDatabase',
            ...
            DatabaseServerApi__pb2.CreateDatabaseResponse.FromString,
    ...
    def ResetDatabase(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/com.server.DatabaseServerService/ResetDatabase',
            Common__pb2.DatabaseIdPasswordRequest.SerializeToString,
            DatabaseServerApi__pb2.CreateDatabaseResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def UpdateDatabaseAllowConnections(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.server.DatabaseServerService/UpdateDatabaseAllowConnections',
            Common__pb2.DatabaseIdConnectionsAllowRequest.SerializeToString,
            Common__pb2.ResponseResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetDatabaseStats(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/com.server.DatabaseServerService/GetDatabaseStats',
            Common__pb2.DatabaseIdRequest.SerializeToString,
            DatabaseServerApi__pb2.DatabaseStatsOnServerResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
